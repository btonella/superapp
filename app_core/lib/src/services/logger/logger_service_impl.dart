...
///
/// A classe [LoggerServicesImpl] implementa a interface [LoggerServices] e fornece
/// serviços de logging para a biblioteca.
///
...
///
/// [LoggerServicesImpl] é responsável por todo o **log** da aplicação.
///
...
class LoggerServicesImpl implements LoggerServices {
  late Logger logger;
  ...
  ///
  void init() {
    const level = String.fromEnvironment('DEFINE_LOG_LEVEL', defaultValue: 'INFO');
    logger = Logger(
