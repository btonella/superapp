...
///
/// A classe [LoggerServices] é uma classe abstrata que define os métodos para registrar logs
/// em diferentes tipos.
///
...
/// especifica o tipo de log, que é do tipo [LogType].
///
...
abstract class LoggerServices {
  ...
  /// (que contém a pilha de chamadas do erro).
  ///
  void error(String message, [dynamic error, DateTime? dateTime, StackTrace? stackTrace]);
}
